...
export default function Sidebar() {
  ...
  return (
    <aside className="admin-sidebar fixed left-0 top-0 h-screen w-64 flex flex-col z-40">
      {/* Logo area */}
      <div className="flex items-center gap-3 px-6 py-6 border-b border-white/10">
        <div className="w-9 h-9 rounded-lg bg-gold flex items-center justify-center">
          <span className="text-navy font-bold text-sm">TFS</span>
        </div>
        <div>
          <span className="text-white font-bold text-lg">TFS</span>{" "}
          <span className="text-gold font-semibold text-lg">Admin</span>
        </div>
      </div>
          ...
          return (
            <Link
              ...
              className={`flex items-center gap-3 px-4 py-3 text-sm font-medium rounded-lg transition ${
                active
                  ? "text-gold bg-gold/10 border-l-[3px] border-gold"
      ...
      <div className="px-3 py-4 border-t border-white/10">
        <button
          ...
          className="flex items-center gap-3 px-4 py-3 text-sm font-medium rounded-lg transition text-white/70 hover:text-white hover:bg-white/5 w-full"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="20"
